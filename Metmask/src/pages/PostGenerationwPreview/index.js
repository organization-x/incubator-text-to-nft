...
const PostGenerationwPreviewPage = () => {
  return (
    <>
      <Column className="bg-gray_900 font-inter items-end justify-end mx-[auto] lg:p-[14px] xl:p-[16px] 2xl:p-[19px] 3xl:p-[22px] w-[100%]">
        <Column className="items-center 3xl:mt-[11px] lg:mt-[7px] xl:mt-[8px] 2xl:mt-[9px] w-[98%]">
          ...
          />
          <Img
            src="images/img_previewimages.svg"
        ...
        <Row className="justify-end lg:mb-[3px] 2xl:mb-[4px] xl:mb-[4px] 3xl:mb-[5px] 3xl:mt-[110px] lg:mt-[71px] xl:mt-[82px] 2xl:mt-[92px] w-[59%]">
          <Stack className="lg:h-[35px] xl:h-[40px] 2xl:h-[45px] 3xl:h-[54px] w-[30%]">
            <Column className="absolute bg-bluegray_700 inset-x-[10%] items-center justify-end lg:p-[5px] xl:p-[6px] 2xl:p-[7px] 3xl:p-[9px] w-[80%]">
            ...
            <div className="absolute bg-bluegray_700 lg:h-[35px] xl:h-[40px] 2xl:h-[45px] 3xl:h-[54px] right-[0] rounded-radius2582 w-[20%]"></div>
            <div className="absolute bg-bluegray_700 lg:h-[35px] xl:h-[40px] 2xl:h-[45px] 3xl:h-[54px] left-[0] rounded-radius2582 w-[20%]"></div>
          </Stack>
...
export default PostGenerationwPreviewPage;
