    ...
    <form action="/post" method="post" 
      ...
      <Column className="bg-gray_900 font-inter items-center mx-[auto] lg:p-[22px] xl:p-[25px] 2xl:p-[28px] 3xl:p-[34px] w-[100%]">
        ...
        <Text className="font-normal lg:mt-[100px] xl:mt-[115px] 2xl:mt-[129px] 3xl:mt-[155px] not-italic lg:text-[17px] xl:text-[20px] 2xl:text-[22px] 3xl:text-[27px] text-white_A700 w-[auto]">
          ...
          <input id='address' name="address" value="address" type="text" style={{  'position': 'absolute', 'background-color': '#17171B', 'border-color' : '#17171B', 'color' : 'white', 'width' : '95%', 'left' : '2%', 'font-size' : '16px', 'height' : '20px', 'top' : '25%'}}/>
          <Img
          ...
          <span id="AddressPrompt" style={{'position': 'relative'}}>
          <input id='key' name="key" value="key" type="text" style={{  'position': 'absolute', 'background-color': '#17171B', 'border-color' : '#17171B', 'color' : 'white', 'width' : '95%', 'left' : '2%', 'font-size' : '16px', 'top' : '60%', 'height' : '20px'}}/>
          <Img
            src="images/img_prompt.svg"
